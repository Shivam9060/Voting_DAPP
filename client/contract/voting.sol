...
contract Vote {
    ...
    function voterRegister(string calldata _name,uint256 _age,string calldata _gender) external returns (bool) {
    ...
    function candidateRegister(string calldata _name,string calldata _party,uint256 _age,string calldata _gender) external {
        require(candidateVerification(msg.sender),"You have already registerd");
